...
public class Bootcamp {
	...
	private final LocalDate dataInicial = LocalDate.now(); //Data inicial
	private final LocalDate dataFinal = dataInicial.plusDays(45); // Data final
	private Set<Dev> devsInscritos = new HashSet<>(); //inscritos 
	private Set<Conteudo> conteudos = new LinkedHashSet<>(); // conteudos em ordem
